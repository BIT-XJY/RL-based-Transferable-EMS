...
class Prius_model():
    def __init__(self):
        # paramsmeters of car
        self.Wheel_R = 0.287
        self.mass = 1449          # Curb weight
        self.C_roll  = 0.013      # Roll resistance coefficient
        self.density_air = 1.2    # Air density
        self.area_frontal = 2.23  # Frontal area
        self.G = 9.81             # Gravitational acceleration
        self.C_d = 0.26           # Air resistance coefficient
        self.T_factor = 1         # The factor of F_roll
       
        # paramsmeters of transmission system
        self.Pgs_R = 78      # Number of teeth on the ring
        self.Pgs_S = 30      # Number of teeth on sun wheel
        self.Pgs_K = 3.93    # Speed ratio from ring gear to wheel
        ...
        self.Batt_I_max_dis = 196    # Maximum discharging current
        self.Batt_I_max_chg = 120    # Maximum charging current
        
        
    def run(self, car_spd, car_a, Eng_pwr_opt, SOC):
        # car_spd: vehicle longitudinal speed,
        # car_a: vehicle longitudinal acceleration,
        # Eng_pwr_opt: optimum engine power,
        # SOC: state of charge
